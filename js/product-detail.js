...
if (
  ...
  const showcaseImages = [
    {
      image: "../images/products/wpc/wpc2.webp",
      alt: "WPC 데크 제품 이미지"
    },
  ...
  const updateShowcase = (index) => {
    currentIndex =
      (index + showcaseImages.length) % showcaseImages.length;

    const selectedImage = showcaseImages[currentIndex];

    showcaseMainImage.src = selectedImage.image;
    showcaseMainImage.alt = selectedImage.alt;
